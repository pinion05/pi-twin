...
| `Extensions/Extensions.md` | `settings.json` → `packages[]` | 양방향 |
| `Extensions/Extension-*.md` | `subagents.agentOverrides` | 양방향 ("현재 설정" 섹션) |
...
- 스킬: `source`(설치위치) · `tags` · `status` · `description_tokens` → `Skills/index.base`
